parameters = {
  ...
  "cart.dev.CATALOGUE_HOST"    = { type = "String", value = "catalogue-dev.techmythree.online" }
  "cart.dev.CATALOGUE_PORT"    = { type = "String", value = "80" }
  "shipping.dev.CART_ENDPOINT" = { type = "String", value = "cart-dev.techmythree.online:80" }
  "shipping.dev.DB_HOST"       = { type = "String", value = "dev-mysql-rds-cluster.cluster-cd2kuhl08ucy.us-east-1.rds.amazonaws.com" }
  "payment.dev.CART_HOST" = { type = "String", value = "cart-dev.techmythree.online" }
  "payment.dev.CART_PORT" = { type = "String", value = "80" }
  "payment.dev.USER_HOST" = { type = "String", value = "user-dev.techmythree.online" }
  "payment.dev.USER_PORT" = { type = "String", value = "80" }
  "payment.dev.AMQP_HOST" = { type = "String", value = "rabbitmq-dev.techmythree.online" }
